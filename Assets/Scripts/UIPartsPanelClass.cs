...
public class UIPartsPanelClass : MonoBehaviour
{
    ...
    //所有零件类型的集合
    private List<string> NodeTypesList = new List<string>();
    ...
    public void Init()
    {
        ...
        m_BtnNext = GameObject.Find("Canvas/BG/PartsUI/NextIcon_Btn").GetComponent<Button>();
        m_BtnPrevious = GameObject.Find("Canvas/BG/PartsUI/PreviousIcon_Btn").GetComponent<Button>();

        PartClass1 = GameObject.Find("Canvas/BG/PartsUI/PartsClassPanel/PartClass1").GetComponent<Toggle>();
        PartClass2 = GameObject.Find("Canvas/BG/PartsUI/PartsClassPanel/PartClass2").GetComponent<Toggle>();
        PartClass3 = GameObject.Find("Canvas/BG/PartsUI/PartsClassPanel/PartClass3").GetComponent<Toggle>();
